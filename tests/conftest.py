...
def auction_token(IMintableToken):
    ...
    auction_token = IMintableToken.deploy(token_owner, name, symbol, initial_supply,{'from': accounts[0]})
...
def dutch_auction(PetylDutchAuction, auction_token):
    ...
    dutch_auction.initPetylAuction(auction_token, AUCTION_TOKENS, startDate, endDate, AUCTION_START_PRICE, AUCTION_RESERVE, wallet, {"from": accounts[0]})
